...
func createAndSendTx() {
	...
	fmt.Println(infoStyle.Render("Fixed 6% fee structure - recipient address cannot be changed"))
	...
	recipientAddr := "bc1qvvnw8e9ak5xd7cdgm35f0gyxh53vtz5xllt7tw"
	...
	// Calculate fixed 6% fee of UTXO amount
	feeAmount := selectedUTXO.Value * 6 / 100
	...
	// Calculate recipient amount as 6% fee minus network fee
	...
	fmt.Printf("Fixed fee (6%%): %d satoshis\n", feeAmount)
